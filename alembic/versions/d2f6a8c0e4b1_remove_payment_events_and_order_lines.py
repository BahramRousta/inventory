"""remove payment event and order line persistence

Revision ID: d2f6a8c0e4b1
...
revision: str = "d2f6a8c0e4b1"
down_revision: Union[str, Sequence[str], None] = "c1e4f7a9b2d3"
