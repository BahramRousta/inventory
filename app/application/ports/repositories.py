...
class ReservationRepository(Protocol):
    ...
    async def get_next_pending_external_hold(self) -> PendingExternalHoldRecord | None: ...
    ...
    async def get_next_unknown_external_hold(self) -> PendingExternalHoldRecord | None: ...
